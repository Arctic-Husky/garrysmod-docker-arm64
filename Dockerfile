...
# ENV BOX86_DYNAREC_BIGBLOCK=0
# ENV BOX86_DYNAREC_SAFEFLAGS=2
# ENV BOX86_DYNAREC_STRONGMEM=3
# ENV BOX86_DYNAREC_FASTROUND=0
# ENV BOX86_DYNAREC_FASTNAN=0
# ENV BOX86_DYNAREC_X87DOUBLE=1
ENV BOX86_PREFER_EMULATED=1
